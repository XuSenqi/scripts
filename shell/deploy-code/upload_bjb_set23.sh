...
APPS=(uhost-scheduler)
#APPS=(uhost-access uhost-manager)
for APP in ${APPS[*]}
do
    ./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/uhost/$APP root 172.27.247.168 /data/node-framework/node_modules/$APP
    ./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/uhost/$APP root 172.27.247.170 /data/node-framework/node_modules/$APP
done
