...
for APP in ${APPS[*]}
do
    ./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/uhost-readonly/$APP root 172.28.226.124 /data/node-framework/node_modules/$APP
    ./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/uhost-readonly/$APP root 172.28.226.125 /data/node-framework/node_modules/$APP
done
