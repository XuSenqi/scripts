...
#done
#
./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/message/*.284 root 192.168.154.106 /root/wiwo/libs
./upload.sh patrickxu 192.168.150.116 /data/Patrick.Xu/message/*.284 root 192.168.154.107 /root/wiwo/libs
